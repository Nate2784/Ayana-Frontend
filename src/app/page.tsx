...
import { MoveRight, Star, CalendarDays, Award } from "lucide-react"; 
...
export default function Home() {
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <section className="relative w-full h-[90vh] flex items-center justify-center bg-brand-navy overflow-hidden">
        ...
        >
          ...
          <motion.p 
            ...
            variants={fadeInUp}
          >
            Ayana General Trading: The gold standard in meticulous planning, sophisticated design, and flawless event execution.
          </motion.p>
      ...
      <section className="w-full py-28 px-6 bg-brand-light">
        ...
        >
          <motion.div className="text-center mb-20" variants={fadeInUp}>
            <h2 className="text-4xl md:text-5xl mb-4 text-brand-navy">Our Expertise</h2>
            <div className="h-1 w-24 bg-brand-gold mx-auto rounded"></div>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              { icon: Award, title: "Corporate Galas", text: "Impeccable product launches, conferences, and award ceremonies." },
              { icon: Star, title: "Bespoke Celebrations", text: "Weddings, private parties, and milestone events tailored exclusively for you." },
              { icon: CalendarDays, title: "General Trading", text: "Trading of high-end event decor, audio-visual equipment, and luxury furnishings." },
            ].map((service, i) => (
              <motion.div 
                key={i} 
      ...
      {/* 3. PORTFOLIO SHOWCASE - Gallery Link Restored */}
      ...
      <section className="w-full py-32 bg-brand-navy text-white text-center px-6 relative overflow-hidden mb-24 rounded-b-[3rem] md:rounded-b-[5rem]">
        <motion.span 
          animate={{ rotate: 360 }} 
          transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
          className="absolute text-[20rem] font-serif text-brand-gold opacity-5 top-0 left-[-100px] select-none pointer-events-none"
        >
          ★
        </motion.span>
        ...
        >
          ...
          >
            Your Next Vision<br /> 
            <span className="text-transparent bg-clip-text bg-shiny-gold">Is Ready</span>
          </motion.h2>
          
          <motion.p 
            variants={fadeInUp}
            className="text-lg md:text-xl text-gray-300 mb-12 font-light max-w-xl leading-relaxed"
          >
            Book a complimentary design consultation with our expert team to conceptualize your golden moment.
          </motion.p>
          ...
          <motion.div variants={fadeInUp}>
            <Link href="/contact">
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="btn-gold !py-4 !px-12 text-base shadow-2xl shadow-brand-gold/20"
              >
