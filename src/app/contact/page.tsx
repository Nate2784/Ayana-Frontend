    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 max-w-7xl mx-auto space-y-12 relative">
      ...
      <div className="grid md:grid-cols-12 gap-8 lg:gap-12 items-stretch">
        ...
        >
          ...
          <div className="mt-12 flex items-center gap-2 text-brand-gold font-medium"><Globe className="w-4 h-4" /><span className="text-[10px] uppercase tracking-[0.2em]">www.ayanatrading.com</span></div>
        </motion.div>
